        ...
        function existeDocumento(id_tipo, id_proveedor, folio) {
            ...
            try {
                ...
                if (facturas_afectas.length > 0) {
                    return "Ya existe la factura afecta id " + facturas_afectas[0].id + " con el mismo tipo de documento, RUT proveedor y folio.";
                }
                ...
                if (facturas_exentas.length > 0) {
                    return "Ya existe la factura exenta id " + facturas_exentas[0].id + " con el mismo tipo de documento, RUT proveedor y folio.";
                }
                ...
                if (boletas_honorario.length > 0) {
                    return "Ya existe la boleta de honorario id " + boletas_honorario[0].id + " con el mismo RUT proveedor y folio.";
                }
